    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden font-mono">
      ...
      <nav className={`fixed top-8 left-0 right-0 z-40 transition-all duration-500 ${scrolled ? 'bg-black/90 backdrop-blur border-b border-red-900/50' : ''}`}>
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <a href="https://pump.fun/coin/8EQReFFx9KTSBD3ozjjR6LYsHEv6e7RH9HhhHUSUpump" target="_blank" rel="noopener noreferrer" className="text-xs border border-red-700 text-red-400 px-4 py-2 hover:bg-red-900/40 transition-all tracking-widest uppercase">
            Join Order
          </a>
        </div>
      </nav>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-4">
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 items-center" id="join">
            <a href="https://pump.fun/coin/8EQReFFx9KTSBD3ozjjR6LYsHEv6e7RH9HhhHUSUpump" target="_blank" rel="noopener noreferrer" className="join-btn relative px-10 py-4 text-sm font-black tracking-widest uppercase overflow-hidden group">
              <span className="relative z-10">☣ JOIN THE ORDER</span>
            </a>
            <a href="https://pump.fun/coin/8EQReFFx9KTSBD3ozjjR6LYsHEv6e7RH9HhhHUSUpump" target="_blank" rel="noopener noreferrer" className="px-10 py-4 text-sm font-bold tracking-widest uppercase border border-red-800 text-red-400 hover:border-red-500 hover:text-red-200 hover:bg-red-950/40 transition-all duration-300">
              BUY $HWO
            </a>
          </div>
